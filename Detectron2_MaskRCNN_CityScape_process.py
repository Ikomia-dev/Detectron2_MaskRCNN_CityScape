...
# --------------------
class Detectron2_MaskRCNN_CityScapeParam(core.CProtocolTaskParam):
...
# --------------------
class Detectron2_MaskRCNN_CityScapeProcess(dataprocess.CImageProcess2d):
...
# --------------------
class Detectron2_MaskRCNN_CityScapeProcessFactory(dataprocess.CProcessFactory):
